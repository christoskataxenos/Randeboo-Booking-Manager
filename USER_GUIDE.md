...
3. [3. Διαχείριση Πελατών](#3-διαχείριση-πελατών)
4. [4. Διαχείριση Προσωπικού (Υπάλληλοι)](#4-διαχείριση-προσωπικού-υπάλληλοι)
5. [5. Ημερολόγιο & Διαχείριση Ραντεβού](#5-ημερολόγιο--διαχείριση-ραντεβού)
6. [6. Γρήγορη Κράτηση Ραντεβού (Quick Booking)](#6-γρήγορη-κράτηση-ραντεβού-quick-booking)
7. [7. Αναζήτηση & Φιλτράρισμα Ραντεβού](#7-αναζήτηση--φιλτράρισμα-ραντεβού)
8. [8. Στατιστικά & Αναφορές (Analytics)](#8-στατιστικά--αναφορές-analytics)
9. [9. Ρυθμίσεις & Αντίγραφα Ασφαλείας (Backup/Restore)](#9-ρυθμίσεις--αντίγραφα-ασφαλείας-backuprestore)
10. [10. Διαχείριση Χρηστών (Admin Panel)](#10-διαχείριση-χρηστών-admin-panel)
...
![Διαχείριση Πελατών](docs/images/03_customers.png)
*Εικόνα 3: Λίστα πελατών με δυνατότητα αναζήτησης και επεξεργασίας.*
...
## 4. Διαχείριση Προσωπικού (Υπάλληλοι)

Εδώ μπορείτε να διαχειριστείτε τους υπαλλήλους της επιχείρησής σας και να ορίσετε τις υπηρεσίες που παρέχει ο καθένας.

![Διαχείριση Προσωπικού](docs/images/04_employees.png)
*Εικόνα 4: Οθόνη διαχείρισης προσωπικού.*
...
## 5. Ημερολόγιο & Διαχείριση Ραντεβού

Αυτή είναι η καρδιά της εφαρμογής. Σας επιτρέπει να βλέπετε και να προγραμματίζετε ραντεβού ανά ημέρα και ανά υπάλληλο.

![Ημερολόγιο Ραντεβού](docs/images/05_calendar.png)
*Εικόνα 5: Ημερήσια προβολή ραντεβού με διαθέσιμες χρονοθυρίδες (slots).*
...
## 6. Γρήγορη Κράτηση Ραντεβού (Quick Booking)
...
![Γρήγορη Κράτηση](docs/images/06_quick_booking.png)
*Εικόνα 6: Αναδυόμενη φόρμα για ταχύτατη καταχώρηση ραντεβού.*
...
## 7. Αναζήτηση & Φιλτράρισμα Ραντεβού

Αν θέλετε να βρείτε ένα συγκεκριμένο ραντεβού στο παρελθόν ή στο μέλλον, χρησιμοποιήστε την Advanced Search οθόνη.

![Αναζήτηση Ραντεβού](docs/images/07_search.png)
*Εικόνα 7: Οθόνη αναζήτησης με πολλαπλά κριτήρια.*
...
## 8. Στατιστικά & Αναφορές (Analytics)

Δείτε την πορεία της επιχείρησής σας μέσα από δυναμικά και διαδραστικά γραφήματα.

![Στατιστικά Εφαρμογής](docs/images/08_stats.png)
*Εικόνα 8: Αναλύσεις εσόδων, δημοφιλών υπηρεσιών και απόδοσης προσωπικού.*
...
## 9. Ρυθμίσεις & Αντίγραφα Ασφαλείας (Backup/Restore)

Εδώ διαμορφώνετε τις παραμέτρους της εφαρμογής και προστατεύετε τα δεδομένα σας.

![Ρυθμίσεις & Backup](docs/images/09_settings.png)
*Εικόνα 9: Πάνελ ρυθμίσεων και διαχείρισης βάσης δεδομένων.*
...
## 10. Διαχείριση Χρηστών (Admin Panel)
...
![Διαχείριση Χρηστών](docs/images/10_users.png)
*Εικόνα 10: Λίστα χρηστών της εφαρμογής με φίλτρα αναζήτησης.*
